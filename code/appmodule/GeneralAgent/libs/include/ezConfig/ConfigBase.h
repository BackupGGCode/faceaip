/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * ConfigBase.h - _explain_
 *
 * Copyright (C) 2011 ezlibs.com, All Rights Reserved.
 *
 * $Id: ConfigBase.h 5884 2010-03-13 04:25:19Z WuJunjie $
 *
 *  Explain:
 *     -explain-
 *
 *  Update:
 *     2010-03-13 04:25:19  Create
 *     2013-06-08 13:50:34 Modify add 4 exchange interface
 */
/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
...
public:
	CConfigExchange(int n, int& used, long id/*set to myid*/, TCONFIG_SIGNAL& sig);
	virtual ~CConfigExchange(){};
	//~CConfigExchange(){};
	...
	//
	void exchange(CConfigTable& table, CConfigKey key, unsigned short & value, unsigned short min, unsigned short max, unsigned short dflt);
	void exchange(CConfigTable& table, CConfigKey key, unsigned short & value, unsigned short dflt);
	void exchange(CConfigTable& table, CConfigKey key, unsigned int & value, unsigned int min, unsigned int max, unsigned int dflt);
...
{
public:
	TConfig():CConfigExchange(number, m_used, (long)(&m_latest), m_sigConfig)
	{
	}
	virtual ~TConfig()
	{
