...
#ifdef TSHOME
PJ_DECL(void) tshome_set_ice_ufrag(pj_ice_strans *ice_st, pj_str_t *ufrag);
PJ_DECL(void) tshome_set_ice_upass(pj_ice_strans *ice_st, pj_str_t *upass);
#endif
...
#ifdef TSHOME
PJ_DECL(pj_status_t) pj_ice_strans_sendto_srv (pj_ice_strans *ice_st,
					  const void *data,
					  pj_size_t data_len);

PJ_DECL(void) tshome_set_peer_id (pj_ice_strans * icest, unsigned peer_id);
PJ_DECL(unsigned) tshome_get_peer_id (pj_ice_strans * icest);
#endif
