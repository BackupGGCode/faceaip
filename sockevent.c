 ...
 *
 * $Id: epoll_conn.c 5884 2013-07-08 04:04:46Z WuJunjie $
 *
 *  Notes:
 *     -
 *       create TCP socket and store then in a epoll file descriptor
 *       build with : gcc -O3 -g -falign-functions=4 -falign-jumps -falign-loops -Wall -o sockevent sockevent.c -lpthread
 *     -
 *
 *  Update:
 *     2013-07-08 04:04:46 WuJunjie Create
 */
/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
