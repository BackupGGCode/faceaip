...
#ifdef TSHOME
    PJ_STUN_SDP_REQUEST                     = 0x0301,
    PJ_STUN_SDP_RESPONSE                    = 0x0302,
    PJ_STUN_ERROR_RESPONSE                  = 0x0303,

    PJ_STUN_CMD_REQUEST                     = 0x0304,
    PJ_STUN_CMD_RESPONSE                    = 0x0305,
    PJ_STUN_CMD_ERR_RESPONSE                = 0x0306,
#endif
