...
typedef struct tsp_hanlder_t tsp_handler;
typedef struct udb_manager_t ts_udb_mgr;
...
typedef struct user_sdp_t user_sdp;
typedef struct user_info ts_user;
typedef struct ipc_handler_t ipc_handler;
