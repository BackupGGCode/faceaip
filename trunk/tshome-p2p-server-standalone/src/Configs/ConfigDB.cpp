...
#define MYSQLD_USER "remoteuser"
#define MYSQLD_PWDD "reloginuse0911"
#define MYSQLD_DBNA "remoteserver"
#define MYSQLD_PORT 0
#define MYSQLD_PORT_STR "0"

template<> void exchangeTable<ConfigDB>(CConfigExchange& xchg, CConfigTable& table, ConfigDB& config, int index, int app)
{
