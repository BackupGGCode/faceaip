/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * TSHomeWebServiceIF.h - _explain_
 *
 * Copyright (C) 2011 ezlibs.com, All Rights Reserved.
 *
 * $Id: TSHomeWebServiceIF.h 5884 2013-01-29 03:20:41Z WuJunjie $
 *
 *  Explain:
 *     -explain-
 *
...
#ifndef _TSHomeWebServiceIF_H
#define _TSHomeWebServiceIF_H

#include <json.h>
#include <algorithm>
#include <stdio.h>

#include "TSHomeWebServiceMsg.h"

class CTSHomeWebServiceIF
{
public :
    CTSHomeWebServiceIF();
    virtual ~CTSHomeWebServiceIF();
